#fro eyes and %s hair." % (my_eyes, my_hair) '/home/sheetal/bilateralNN/bilateralnn_code/barrista/barrista/net.py' import *
#ihome/sheetal/darknet/annotate/new/dataset_images/images/frame0707.jpg
from config import *
import numpy as np
import matplotlib
...
#    cnn_model = 'snapshot_models/cnn_train_iter_' + str(itr) + '.caffemodel'
 #   [acc, cnn_iou_values[ct]] = predict(cnn_deploy_file, cnn_model)
    ...
    bnn_model = 'snapshot_models/bnn_train_iter__iter_' + str(itr) + '.caffemodel'
...
plt.plot(iter_values, bnn_iou_values, 'g', linewidth=4.0)
